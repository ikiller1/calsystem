...
session_start();
$qwe="If you need to save really large files bigger then the blob's size limitation or don't have 
...
$data=array();
$time=time();
array_push($data, array("id"=>123),array("lastModified"=>$time),array("qwe"=>$qwe));
$output = json_encode($data);

echo $output;

file_put_contents("infoData.json",$output);
*/
